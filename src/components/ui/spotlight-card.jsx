...
export function GlowCard({ children, className = '', glowColor = 'green' }) {
  ...
  useEffect(() => {
    const onPointerMove = (e) => {
      ...
      // Use element-relative coords so background-attachment:scroll works correctly on iOS
  ...
  const style = {
    ...
    '--radius': '16',
    '--border': '1',
    '--backdrop': 'hsl(222 47% 9% / 1)',
    '--backup-border': 'hsl(222 47% 14% / 1)',
    '--size': '280',
    '--outer': '1',
